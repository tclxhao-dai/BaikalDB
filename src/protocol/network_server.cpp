        ...
        for (auto& pair : sample.internal_map) {
            ...
            for (auto& pair2 : pair.second) {
                ...
                SQL_TRACE("date_hour_min=[%04d-%02d-%02d\t%02d\t%02d] sum_pv_avg_affected_scan_filter_rgcnt_err_size="
                        ...
                        "op_version_desc=[%ld\t%s\t%s\t%s] server_addr=[%s:%d] store_statistics=[%ld %ld %ld %ld %ld %ld %ld]",
                    ...
                    butil::my_ip_cstr(), FLAGS_baikal_port, pair2.second.rocks_get_count, pair2.second.rocks_multiget_count,
                    pair2.second.rocks_seek_count, pair2.second.rocks_scan_count, pair2.second.get_primary_count,
                    pair2.second.lock_cost, pair2.second.wait_cost);
